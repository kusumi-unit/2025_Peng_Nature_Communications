function Detect_IncCol(Gd,Gm,Rd,Rm,PixSize,Th,DtAppG,DtAppR,Kd,Napp_G,Napp_R,Napp_GR,LEr,FilenameRoot)
...
X6 = num2str(PixSize);
X7 = num2str(LEr);
FigTitle{1} = strcat('Apparent total Density (G_R) = ', X1,"_", X1_2, ' (copies/um^2), Kd = ', X2, ' (copies/um^2)'); 
...
%%
% Save figure
Filename1 = strcat(pwd,'/Results/',FilenameRoot, '.fig');
...
Filename2 = strcat(pwd,'/Results/',FilenameRoot, '_Spots.xlsx');
% Delete the file, if exist
delete(Filename2);
