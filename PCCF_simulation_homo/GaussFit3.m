function [Sum] = GaussFit3(A, B, IniC, IniW, IniY0)
...
% 近似タイプとオプションを設定します。
ft = fittype( 'C * exp(-(x^2)/(2*W^2)) + Y0', 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( 'Method', 'NonlinearLeastSquares' );
opts.Display = 'Off';
opts.Lower = [0 0 0];
opts.StartPoint = [IniC, IniW, IniY0];
